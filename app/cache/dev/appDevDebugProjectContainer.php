...
class appDevDebugProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'testowy', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'\\src\\EpopeeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\ProjektBundle\\Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'EpopeeBundle\\Entity');
        $c->addDriver($b, 'ProjektBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('EpopeeBundle' => 'EpopeeBundle\\Entity', 'ProjektBundle' => 'ProjektBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_40b8284b2134f708918d4dde99e9d12872b526f8823aa6449e5629385039e8ed');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('ProjektBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('ProjektBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('ProjektBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('ProjektBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'ProjektBundle\\Entity\\User');
    }
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\EpopeeBundle/Resources/views'), 'Epopee');
        $instance->addPath(($this->targetDirs[3].'\\src\\ProjektBundle/Resources/views'), 'Projekt');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('afe965be32a0a783e2cb5126f5f3104b905359c1');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'EpopeeBundle' => 'EpopeeBundle\\EpopeeBundle',
                'ProjektBundle' => 'ProjektBundle\\ProjektBundle',
            ...
            'secret' => 'afe965be32a0a783e2cb5126f5f3104b905359c1',
            'locale' => 'en',
            ...
            'kernel.secret' => 'afe965be32a0a783e2cb5126f5f3104b905359c1',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => '127.0.0.',
            ...
            'fos_user.model.user.class' => 'ProjektBundle\\Entity\\User',
