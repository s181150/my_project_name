...
class Car
{
     ...
     * Add categories
     *
     * @param \ProjektBundle\Entity\CarCategory $categories
     * @return Car
     */
    public function addCategory(\ProjektBundle\Entity\CarCategory $categories)
    {
     ...
     * @param \ProjektBundle\Entity\CarCategory $categories
     */
    public function removeCategory(\ProjektBundle\Entity\CarCategory $categories)
    {
